...
!-----------------------------------------------------------------------
! Program unit name: Wiener
! Program unit description: processo di Wiener per turbolenza omogenea,
! rilascio istantaneo e puntuale. Year: 2006.
!-----------------------------------------------------------------------
      PROGRAM Wiener
